...
def p_body(p):
  '''body : CHAVE_ABRE comandos CHAVE_FECHA
          ...
          | CHAVE_ABRE CHAVE_FECHA RETURN exp'''
  
def p_comandos(p):
  '''comandos : condicional_1
              | condicional_2
...
#def p_condicional(p):
 # '''condicional : condicional_1
  #               | condicional_2'''

def p_condicional_1(p):
  '''condicional_1 : IF PARENT_ABRE exp PARENT_FECHA condicional_1 body ELSE condicional_1 body
                   | decl_variavel
...
def p_condicional_2(p):
  '''condicional_2 : IF PARENT_ABRE exp PARENT_FECHA body comandos
                   | IF PARENT_ABRE exp PARENT_FECHA body condicional_1 ELSE body condicional_2'''
  
def p_repeticao(p):
  '''repeticao : WHILE PARENT_ABRE exp PARENT_FECHA body
